...
import { Bubble, GiftedChat, InputToolbar, Send, SystemMessage, Time } from 'react-native-gifted-chat'
        ...
        <GiftedChat
          ...
          renderSystemMessage={(props) => {
            return <SystemMessage
              {...props}
              textStyle={{ color: "white", fontSize: 13, backgroundColor: '#306c60', padding: 15, borderRadius: 15 }} />
          }}
          renderAvatar={null}
